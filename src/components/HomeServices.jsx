...
import { ArrowUpRight, Check, Film, TrendingUp, FileText, ExternalLink } from 'lucide-react';
import { servicesData, personalInfo } from '../data/siteData';

export default function HomeServices({ onNavigate }) {
  // Take 3 core services for the concise homepage
  ...
  const getServiceIcon = (id) => {
    switch (id) {
      ...
      default: return <Film className="w-5 h-5 text-[#ccff00]" />;
    }
  };
  ...
  return (
    <section id="services" className="relative py-24 md:py-32 bg-[#0b0b0b] text-white overflow-hidden editorial-grain">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 border-b border-white/10 pb-8">
          <div>
            <div className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-[#ccff00] mb-2">
              ...
              <span>•</span>
              <span className="text-zinc-400">CORE OFFERINGS</span>
            </div>
          ...
          <p className="font-sans text-sm text-zinc-400 max-w-md leading-relaxed">
            Specialized pillars designed to turn raw concepts into captivating, high-retention YouTube programming.
          </p>
        </div>
          ...
          {homeServices.map((service) => (
            ...
            >
              <div>
                ...
                <h3 className="font-display font-extrabold text-2xl text-white group-hover:text-[#ccff00] transition-colors mb-2">
                  {service.title}
                </h3>
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 font-mono text-xs text-[#ccff00] hover:text-white transition-colors"
                >
        ...
        {/* View Detailed Capabilities Callout */}
        <div className="mt-12 text-center">
          ...
          >
            <span>View Full 7-Step Workflow & Capabilities</span>
